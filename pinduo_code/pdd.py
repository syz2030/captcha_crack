...
def get_json_msg(session, req_params):
    ...
    headers = {
        ...
        'Accept': '*/*',
        'Referer': 'http://mobile.yangkeduo.com/search_result.html?search_key=',
...
if __name__ == '__main__':
    # get_data()
    url = 'https://youhui.pinduoduo.com/goods/goods-detail?goodsId=27982667388'
    get_anticontent(url)